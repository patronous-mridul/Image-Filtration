...
while(True):
    ...
    save=int(input('Do you want to save? Press "1" for Yes or "0" for No :'))
    if save==1:
        file=raw_input('Enter the image name to be saved :')
        cv2.imwrite(file+'.jpg',img1)
    elif save==0:
        print('Its ok')
    else:
        print('invalid input')
    a=int(input('Do you break? Press "1" for Yes or "0" for No : '))
    if a==1:
        break
    elif a==0:
        print('Its ok')
